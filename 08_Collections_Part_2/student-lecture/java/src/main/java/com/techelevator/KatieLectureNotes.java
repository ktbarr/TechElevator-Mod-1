...
public class KatieLectureNotes {
	...
	public static void main(String[] args) 
	{
		...
		// Map is a class, Entry is a data type within Map. Will only be used with Map
		...
		// remove some objects
		// when you remove the key it removes the whole row. 
		dailySpecials.remove("Monday");
		
		// adding to the value of the key (updating the value text/int)
		// to append:

...
public class Examples {
	...
	public static void main(String[] args) {
		...
		// x++ : increments by 1 : x = 1; y = x++; answer y = 1
		// ++x : increments by 1 
		// x-- : decrements by 1
		// --x : decrements by 1
		...
		// the right hand side of the operator can be an expression - answer is 15
		x = 5;
		y = 2;
		...
		// Print whether each number between 1 and 10 (inclusive) is even or odd - if remained = 0, number is even
		...
		// the following line declares an array of Strings with 4 elements - creating this way, blank container with [4] items. 
		...
		// stooges - container; new String[] - builds container; { value1, value2, value3} - creates items in container with this number of items

...
public class Exercises {
	...
	/*
	 ...
	 could just: return arrayLengthAtLeastOne && firstLastEqual;
	 */
	...
	/*
	 3. Return an int array length 3 
	 containing the first 3 digits of pi, {3, 1, 4}.
	 
	 makePi() = [3, 1, 4]
	 
	 Goal is to create array, don't get stuck on makePi
	 */
	public int[] makePi() 
	{
	...
	/*
	 4. Given 2 arrays of ints, a and b, 
	 return true 
	 
	 if they have the same first element : need to get first element
	 or they have the same last element.  : need to get 2nd element
	...
	public boolean commonEnd(int[] a, int[] b) 
	{
		...
		boolean isSecondElementSame = a[a.length -1] == b[b.length -1];
			
		return isFirstElementSame || isSecondElementSame;
	}
	...
	/*
	 ...
	 tells us there will be 3 elements
	 return the sum of all elements - [0] + [1] + [2]
	...
	public int[] maxEnd3(int[] nums) 
	{
		...
		int[] returnLargest = new int[3];
		returnLargest[0] = biggest;
		returnLargest[1] = biggest;
		returnLargest[2] = biggest;
	 ...
	 *basic sum function* add to notes* 
	 */

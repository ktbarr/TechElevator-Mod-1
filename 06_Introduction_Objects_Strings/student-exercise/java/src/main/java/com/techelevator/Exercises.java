...
public class Exercises {
	...
	public String makeOutWord(String out, String word) 
	{
		...
		String newString = out1 + word + out2;
	...
	public String extraEnd(String str) 
	{
		...
		String newString2 = lastTwoChar + lastTwoChar + lastTwoChar;
	...
	public boolean endsLy(String str) 
	{
		...
		else if (endingLy.equals(str.subSequence(allLength -2, allLength))) 
		{
			return true;
		}
		else 
	...
	public String middleThree(String str) 
	{
		...
		return str.substring(oddLength - 1, oddLength + 2);
	}
	...
	public boolean hasBad(String str) 
	{
		...
		{
			if ((str.subSequence(1, 4)).equals("bad")) 
			{
				return true;
			}
	...
	public int countXX(String str) 
	{
		...
		{
			if (str.subSequence(i, i + 2).equals("xx")) count++;
		}
		return count;
	}
	...
	public boolean doubleX(String str) 
	{
		...
		String xString = str.substring(i);
	...
	{
		int bitsLength = str.length();
		String bitsTemporary = "";
		
		for(int i = 0; i < bitsLength; i = i +2) 
		{
			bitsTemporary += str.charAt(i);
		}
		return bitsTemporary;
	}
	...
	{
		int splosionLength = str.length();
		String tempSplosion = "";
		
		for(int i =0; i < splosionLength + 1; i++) 
		{
			tempSplosion += str.substring(0, i);
		}
		return tempSplosion;
	}
	...
	public int last2(String str) 
	{
		...
		String endItems = str.substring(str.length() - 2);
	...
	public String stringX(String str) 
	{
		...
		for(int i = 0; i < xLength; i++) 
		{
			...
			if (!(i > 0 && i < xLength -1 && temporary == 'x')) 
			{
				resultX = resultX + temporary;
			}
		}
		return resultX;
	}
	...
	public String altPairs(String str) 
	{
		...
		for(int i = 0; i < str.length(); i += 4) 
		{
			...
			resultPairs = resultPairs + str.substring(i , ending);
		}
		return resultPairs;
	}
	...
	public String stringYak(String str) 
	{
		...
		for(int i = 0; i < str.length(); i++) 
		{
			...
			{
				resultYak = resultYak + str.charAt(i);
			}
		}
